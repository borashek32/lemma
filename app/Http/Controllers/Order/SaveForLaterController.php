...
class SaveForLaterController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return back()->with('success', 'Product was successfully removed from the products had been saved for later');
    }

    /**
     * Switch product to the cart again.
     *
     * @param  int  $id
     * @return \Illuminate\Http\RedirectResponse
     */
    ...
    public function switchToCart($id)
    {
        ...
        return redirect()
            ->route('cart.index')
            ->with('success', 'Product was successfully moved to cart');
    }
}
