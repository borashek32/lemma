                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" class="phone shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline @error('phone') border-red-500 @enderror" id="exampleFormControlInput3"
                                      wire:model="phone" placeholder="Введите номер телефона">
