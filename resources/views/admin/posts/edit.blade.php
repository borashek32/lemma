            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <form action="{{ route('posts.update', $post->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <img src="@if($post->img) {{ $post->img }} @endif" alt="" width="200" class="img-uploaded mb-2">
                        ...
                        <div class="grid gap-x-8 gap-y-4 grid-cols-2">
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                                leading-tight focus:outline-none focus:shadow-outline mb-4" id="feature_image"
                                   name="img" value="{{ $post->img }}" readonly>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ $tags }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ $post->link }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline @error('link') border-red-500
                            @enderror" id="link" name="link" required>
