...
@section('content')
    <div class="site-index">
        <div class="body-content">
            <h2>Условия гарантии на запасные части на ваш автомобиль</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h5 style="font-weight: 600">Гарантия на запасные части не распространяется в следующих случаях:</h5>
                ...
                <div class="col-lg-4">
                    <h5 style="font-weight: 600">Порядок возврата запасных частей:</h5>
